...
OpenDDS::DCPS::TcpDataLink::send_graceful_disconnect_message()
{
  ...
  *message << header_data;
  ...
  TransportControlElement* send_element = new TransportControlElement(std::move(message));
...
OpenDDS::DCPS::TcpDataLink::send_association_msg(const GUID_t& local, const GUID_t& remote)
{
  ...
  *message << header_data;
  ...
  TransportControlElement* send_element = new TransportControlElement(std::move(message), local);

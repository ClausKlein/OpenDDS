                                                       ...
                                                       bool isBIT)
{
  ...
  if (1 == descriptionLookup) {
    ...
    int descriptionAddition = add_topic_description(std::move(desc));
  ...
  case 0: {
    ...
    case 0: {
      ...
      this->idToTopicMap_[topicId] = std::move(topic);
...
int DCPS_IR_Domain::add_topic_description(OpenDDS::DCPS::unique_ptr<DCPS_IR_Topic_Description> desc)
{
  ...
  switch (this->find_topic_description(
            ...
            discard)) {
  case -1:
    this->topicDescriptions_[desc_ptr->get_name()] = std::move(desc);
